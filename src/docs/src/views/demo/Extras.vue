          ...
          <article class="media">
            <div class="media-content">
              <div class="content">
                <p>
                  <strong>
                    <a href="//github.com/mubaidr/bulma-fluent">Bulma-Fluent</a>
                  </strong>
                  <small>by
                    <a href="//github.com/mubaidr">mubaidr</a>
                  </small>
                  <br> Fluent Design theme for Bulma, inspired by Microsoft’s Fluent Design System:
                  <a href="//mubaidr.github.io/bulma-fluent">Homepage</a>
                </p>
              </div>
            </div>
          </article>
